...
namespace orm
{
    public class mapper1
    {
        ...
        public mapper1(string path, string connection_string)
        {
        ...
        public bool create(object to_create)
        {
        ...
        public bool update(object to_update)
        {
            //todo
        ...
        public bool delete(object to_delete)
        {
        ...
        public List<object> readall(string classname)
        {
